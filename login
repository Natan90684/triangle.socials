...
<body class='bg-black-100'>
    <%- include('../partials/nav.ejs', {active: "login", user, loggedIn}); %>
    <!--
        ...
        <div class="max-w-md w-full">
            <div>
                ...
                <p class="mt-2 text-center text-sm leading-5 text-gray-500">
                    Or
                    <a href="/join"
                        class="font-medium text-indigo-500 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">
                        Create an account.
                    </a>
                </p>
            </div>
            ...
            <form class="mt-8" action="#" id='form'>
...
<!-- 
 ...
 -->
                <div class="mt-6">
                    <button type="submit"
                        class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-indigo-500 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700 transition duration-150 ease-in-out">
                        Sign in
                    </button>
                </div>
            </form>
